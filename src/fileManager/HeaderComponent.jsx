    ...
    <header className="h-full p-2 border w-full border-gray-400 lg:py-5 sm:px-3 sm:m-2">
      <div className="w-full md:flex md:justify-between overflow-x-scroll sm:overflow-x-clip ">
        <div className="w-full md:w-3/4 lg:2/3  gap-1 sm:gap-0 flex">
          <button
            className="border border-gray-200 sm:px-3 mx-1 sm:py-1 bg-slate-200 font-serif rounded-sm "
          ...
          <span className="flex justify-between sm:flex-row">
            <button className="border border-gray-200 px-4 py-1 mx-1 bg-red-500 rounded-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                <path d="m3.293 11.293 1.414 1.414L11 6.414V20h2V6.414l6.293 6.293 1.414-1.414L12 2.586l-8.707 8.707z" />
              </svg>
            </button>
            <button className="border border-gray-200 px-4 py-1 mx-1 bg-slate-200  rounded-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
          ...
          <label
            htmlFor=""
            className="border mx-1 border-gray-200 px-3 py-1 bg-slate-200 font-serif rounded-sm"
          >
            Sort By
            <select name="" id="">
          ...
          <span className="flex justify-between sm:flex-row">
            <button className="border border-gray-200 py-1 px-4 mx-1 bg-red-500 rounded-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                <path d="M10 10H3V4a1 1 0 0 1 1-1h6zm11-6a1 1 0 0 0-1-1h-6v7h7zM4 21h6v-7H3v6a1 1 0 0 0 1 1zm17-1v-6h-7v7h6a1 1 0 0 0 1-1z" />
              </svg>
            </button>
            <button className="border border-gray-200 py-1 px-4 mx-1 bg-slate-200 text-red-600 font-serif font-bold rounded-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                <g data-name="46-List">
